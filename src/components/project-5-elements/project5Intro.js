    ...
    <section data-scroll-section>
      <Container>
        <h2 className=" w-full pt-4  2xl:pt-12 text-3xl lg:text-4xl 2xl:text-5xl font-semibold">
          Over 1/3 of all the food we are buying ends up as waste. That fact is a literal waste of human
          effort and money, but there is many ways to deak wutg ut both traditional and digital and Left Over
          app focuses on the second one.
        </h2>
        <p className=" pt-4 2xl:pt-8 text-lg lg:text-xl 2xl:text-2xl pb-8 2xl:pb-16">
          Left over was a semseter project that was a full stack soluton to help preventing or at least
          limiting food waste. We combined our design, backend and frontend knowledge into one usable SPA web
          app.
        </p>
            ...
            <ul className="pt-2 lg:pt-4">
              <li>
                <p className="text-lg md:text-2xl">
                  The purpose was to combine our knowledge about backend, frontend and design and create a
                  digital solution that can be actually usable.
                </p>
              </li>
            </ul>
          </div>
