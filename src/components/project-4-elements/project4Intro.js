    ...
    <section data-scroll-section>
      <Container>
        <h2 className=" w-full pt-4  2xl:pt-12 text-3xl lg:text-4xl 2xl:text-5xl font-semibold">
          Smokepins is a small Danish start-up company funded by Ole Grawrok. The company focuses on quality,
          hand made products that come in handy for fisherman, food enthusiasts and all sorts of adventurers.
        </h2>
        <p className=" pt-4 2xl:pt-8 text-lg lg:text-xl 2xl:text-2xl pb-8 2xl:pb-16">
          Our job was to rebrand the company's identity as well as come up with efficient marketing strategy
          that would positivly ifluence company itself as well as it's customers. We achieved that by applying
          several. multimedia strategies and tools. The steps we took turned out to be a success bringing
          client more interest and customers.
        </p>
            ...
            <ul className="pt-2 lg:pt-4">
              <li>
                <p className="text-lg md:text-2xl">
                  To make sure that the identity of the company is properly shown through they digital
                  presence
                </p>
              </li>
            </ul>
