...
const HeroImageBilligAnimation = () => {
  const data = useStaticQuery(graphql`
    query HeroImageBilligAnimationQuery {
      allFile(filter: { name: { eq: "billig-animation-hero-image-project" } }) {
        nodes {
          childrenImageSharp {
...
export default HeroImageBilligAnimation;
