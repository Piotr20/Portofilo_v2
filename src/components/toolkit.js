...
const MyToolkit = () => {
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl xl:text-5xl font-bold text-center py-4 lg:py-8">My toolkit</h2>
      <div className="w-10/12 2xl:w-8/12 grid grid-cols-3 gap-3 justify-items-center md:flex md:flex-wrap md:justify-center items-center  pb-12 md:pb-24">
        ...
        <div className=" self-center">
          <SiIonic className=" toolkit-item w-16 h-16 2xl:w-20 2xl:h-20" />
        </div>
        ...
        <div className=" self-center">
          <SiShopware className="toolkit-item w-16 h-16 2xl:w-20 2xl:h-20" />
        </div>
        <div className=" self-center">
        ...
        <div className="self-center">
          <SiNotion className="toolkit-item w-16 h-16 2xl:w-20 2xl:h-20" />
        </div>
      </div>
    </section>
  );
