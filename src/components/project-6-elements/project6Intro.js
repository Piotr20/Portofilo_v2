    ...
    <section data-scroll-section>
      <Container>
        <h2 className=" w-full pt-4  2xl:pt-12 text-3xl lg:text-4xl 2xl:text-5xl font-semibold">
          Billig animation is a small company located in Aarhus, founded and managed by Daniel Jensen. Company
          makes animation movies for companies and partners of all sizes varying from TV2 to small handy man.
          companies. What makes them different is the fact that they combine quality with price as well as the
          fact that their all truly Danish company.
        </h2>
        <p className=" pt-4 2xl:pt-8 text-lg lg:text-xl 2xl:text-2xl pb-8 2xl:pb-16">
          When we started analysing the company and their digital presence, we did not have any doubts that
          the business model works. Although we also spotted things that do not work and can bring some
          serious benefits to the company and exactly on those aspects we are going to focus on this project.
        </p>
            ...
            <ul className="pt-2 lg:pt-4">
              <li>
                <p className="text-lg md:text-2xl">
                  To find out what does not work in terms of digital presence of the company and create webste
                  that ranks as high as possible in the SEO.
                </p>
              </li>
            </ul>
          </div>
