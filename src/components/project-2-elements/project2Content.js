          ...
          <div className=" md:w-1/2 py-6 md:flex md:justify-center">
            <div className=" md:w-7/12 md:mb-16">
              ...
              <p className=" pt-4 2xl:pt-8 text-lg lg:text-xl 2xl:text-2xl pb-8 2xl:pb-16">
                We created a unique visual identity that carried through all. aspects of the business distingushes Smokepins ApS from other
                competitiors making their brand memorable. This project was not. as much for a coding as it was rather for design and marketing. Even
                though it was not very code-wise project we included. several immersive effects like e. g. lines drawing on scroll.
              </p>
            </div>
          </div>
        </div>
