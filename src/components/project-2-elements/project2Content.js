    ...
    query SigunaVideoQuery {
      allFile(
        filter: {
          ...
          relativePath: { eq: "videos/siguna-page-overview.mp4" }
        }
      ) {
        edges {
          node {
      ...
      <Container>
        ...
        <div className="py-6 flex flex-col">
          <div className="w-full">
            <Project2Image type="desktop-1" />
          </div>
        </div>
        <div className="flex flex-col md:flex-row md:items-center">
          <div className="w-full">
            <Project2Image type="mobile-1" />
          </div>
        ...
        <div className="flex py-6 flex-col md:grid md:grid-cols-3 md:grid-rows-1 md:gap-8">
          <div className="md:col-span-2 md:self-end">
            <Project2Image type="desktop-2" />
          </div>
          <div className="md:col-span-1 ">
            <Project2Image type="mobile-2" />
          </div>
        </div>
        <div className="flex py-6 flex-col md:grid md:grid-cols-2 md:grid-rows-2 md:gap-x-8 md:items-center">
          <div className="col-span-2">
            <Project2Image type="gsap-animation-2" />
          </div>
          <div className="">
            <Project2Image type="gsap-animation-1" />
          </div>

          <div className="md:w-2/3  pt-6">
            <h3 className="font-semibold text-3xl 2xl:text-4xl">GSAP animations:</h3>
            <p className="pt-4 2xl:pt-8 text-lg lg:text-xl 2xl:text-2xl pb-8 2xl:pb-16">
              Animations and being able to interact with a website is a fantastic tool in creating engagement
              for a user ultimetly making them more interested in the product. We decided to use GSAP thanks
              to it's ease of use and being extremly ligtweight library. We used it also to progressive on
              scroll animations like the text extending or filter rotating.
            </p>
          </div>
        </div>
        <div className="flex flex-col md:grid md:grid-cols-2 md:gap-x-8 justify-center items-center">
          <div className="w-full">
            <div className="w-full pb-6">
              <Project2Image type="lighthouse-report" />
            </div>
          </div>
        ...
        <div className="py-6 md:grid grid-cols-2 md:gap-x-8 justify-center items-center">
          ...
          <div className="">
            <Project2Image type="sanity-logo" />
          </div>
        </div>
      </Container>
    </section>
