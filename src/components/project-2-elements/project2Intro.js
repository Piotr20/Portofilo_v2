    ...
    <section data-scroll-section>
      <Container>
        <h2 className=" w-full pt-4  2xl:pt-12 text-3xl lg:text-4xl 2xl:text-5xl font-semibold">
          Siguna is a Danish international company specialised in selling oil filters to fregates and big
          transportation ships all over the Europe and Asia.
        </h2>
        <p className=" pt-4 2xl:pt-8 text-lg lg:text-xl 2xl:text-2xl pb-8 2xl:pb-16">
          Our main focus in this project went into performance and looks of the website. The objective was to
          make the website performant enough so it is possible to use it in the middle of the sea.
        </p>
        <div className="w-full flex flex-col md:flex-row md:justify-between">
          <div className=" lg:w-1/5 py-2 lg:py-4">
            ...
            <ul className="pt-2 lg:pt-4">
              <li>
                <p className="text-lg md:text-2xl">Siguna Industry & Marine ApS</p>
              </li>
            </ul>
          </div>
          <div className=" lg:w-1/5 py-2 lg:py-4">
            ...
            <ul className="pt-2 lg:pt-4">
              <li>
                <p className="text-lg md:text-2xl">
                  The purpose was to create a website that looks good and is exceptionaly performant.
                </p>
              </li>
            </ul>
          </div>
